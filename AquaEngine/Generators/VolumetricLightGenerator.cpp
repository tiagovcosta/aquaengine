...
#include "VolumetricLightGenerator.h"
...
void VolumetricLightGenerator::init(aqua::Renderer& renderer, lua_State* lua_state, Allocator& allocator, LinearAllocator& temp_allocator,
...
void VolumetricLightGenerator::shutdown()
{
...
ShaderResourceH VolumetricLightGenerator::get() const
{
	return _vertical_blur_sr;
}

u32 VolumetricLightGenerator::getSecondaryViews(const Camera& camera, RenderView* out_views)
{
	return 0;
}

void VolumetricLightGenerator::generate(const void* args_, const VisibilityData* visibility)
{
	...
	*/
...

	{
		...
		*((Vector2*)pointer_math::add(cbuffers_data, offset)) = Vector2(1.0f / _width * 2, 1.0f / _height * 2);
